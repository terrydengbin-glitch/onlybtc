...
已接入 `btc_total_state` 雷达，读取 `btc_price`、`btc_1h_close`、`btc_funding_rate`、`btc_open_interest`、`btc_halving_estimated_days`，输出 `radar_outputs`、`feature_values`、`module_json_outputs`。
